...
public abstract class TypeAnnotationTarget {
	...
	TypeAnnotationTarget(int targetType) {
	...
	static class Empty extends TypeAnnotationTarget {

		Empty(int targetType) {
			super(targetType);
		}
	...
	public static class TypeParameter extends TypeAnnotationTarget {
		...
		TypeParameter(int targetType, int parameterIndex) {
			super(targetType);
	...
	public static class Supertype extends TypeAnnotationTarget {
		...
		Supertype(int targetType, int supertypeIndex) {
			super(targetType);
	...
	public static class TypeParameterBound extends TypeAnnotationTarget {
		...
		TypeParameterBound(int targetType, int parameterIndex, int boundIndex) {
			super(targetType);
			this.parameterIndex = parameterIndex;
	...
	public static class FormalParameter extends TypeAnnotationTarget {
		...
		FormalParameter(int targetType, int parameterIndex) {
			super(targetType);
			this.parameterIndex = parameterIndex;
		}
	...
	public static class ThrowsType extends TypeAnnotationTarget {
		...
		ThrowsType(int targetType, int throwsIndex) {
			super(targetType);
	...
	public static class Localvar extends TypeAnnotationTarget {
		...
		Localvar(int targetType, short[] table) {
			super(targetType);
			this.table = table;
		}
	...
	public static class CatchType extends TypeAnnotationTarget {
		...
		CatchType(int targetType, int exceptionIndex) {
			super(targetType);
	...
	public static class Offset extends TypeAnnotationTarget {
		...
		Offset(int targetType, int offset) {
			super(targetType);
			this.offset = offset;
		}
	...
	public static class TypeArgument extends TypeAnnotationTarget {
		...
		TypeArgument(int targetType, int offset, int argumentIndex) {
			super(targetType);
			this.offset = offset;
