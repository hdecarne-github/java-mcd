...
public class BytecodeInstructionReference extends InstructionReference<BytecodeInstructionReferenceEntry> {
	...
	@Override
	protected BytecodeInstructionReferenceEntry newEntry(InstructionReferenceEntry entryData) throws IOException {
		return new BytecodeInstructionReferenceEntry(entryData);
	}
