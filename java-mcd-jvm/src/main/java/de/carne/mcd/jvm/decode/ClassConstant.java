...
class ClassConstant extends AbstractNameConstant {

	public static final byte TAG = 7;

	ClassConstant(ClassInfo classInfo, int nameIndex) {
		super(classInfo, nameIndex);
	}

	@Override
	public void print(ClassPrinter out, ClassContext context) throws IOException {
		out.print(ClassName.effectiveName(ClassName.decode(getNameValue()), this.classInfo.thisClass().getPackageName()));
	}
