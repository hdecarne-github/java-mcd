...
class ByteAnnotationElement extends AbstractConstantValueAnnotationElement {

	public static final int TAG = 'B';

	ByteAnnotationElement(ClassInfo classInfo, int valueIndex) {
	...
	public void print(ClassPrinter out, ClassContext context) throws IOException {
		...
		out.printValue(Integer.toString(value));
	}
