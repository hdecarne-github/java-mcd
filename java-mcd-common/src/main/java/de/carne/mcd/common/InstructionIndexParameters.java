...
public interface InstructionIndexParameters {
	...
	/**
	 * Gets the number of bytes used to encode an {@linkplain Opcode} in the index's lookup table.
	 * 
	 * @return the number of bytes used to encode an {@linkplain Opcode} in the index's lookup table.
	 */
	int opcodeBytes();
