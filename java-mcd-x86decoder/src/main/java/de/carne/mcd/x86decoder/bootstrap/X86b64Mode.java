...
class X86b64Mode extends X86Mode {
	...
	static {
		...
		OPERAND_MAP.put("Eq", X86Symbol.RM64.symbol());
		...
		OPERAND_MAP.put("rAX", X86Symbol.RAX.symbol());
		OPERAND_MAP.put("(ES:)[rDI]", X86Symbol.MRDI.symbol());
		OPERAND_MAP.put("(DS:)[rSI]", X86Symbol.MRSI.symbol());
		OPERAND_MAP.put("(DS):[rSI]", X86Symbol.MRSI.symbol());
	}
