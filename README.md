### Machine Code Decoder collection for user friendly machine code display
...
![Build](https://github.com/hdecarne/java-mcd/actions/workflows/build-on-linux.yml/badge.svg)
